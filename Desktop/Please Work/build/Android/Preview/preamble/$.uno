...
{ 
	public class GeneratedApplication : Outracks.Simulator.Client.Application
	{
		public GeneratedApplication()
			: base(
				new [] 
				{new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("10.116.50.7"), 12124)},"C:\\Users\\rudy0\\Desktop\\Please Work\\Please Work.unoproj",new string[] 
				{ })
		{
