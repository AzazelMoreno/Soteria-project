...
{
    static uSStrong< ::g::Fuse::Font*> LogoFont_;
    static uSStrong< ::g::Fuse::Font*>& LogoFont() { return MainView_typeof()->Init(), LogoFont_; }
    ...
    uStrong< ::g::Fuse::GeoLocation::GeoLocation*> FuseGeoLocationGeoLocation;
