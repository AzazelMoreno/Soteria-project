...
namespace g{struct PleaseWork_FuseControlsMapView_Latitude_Property;}
...
struct PleaseWork_FuseControlsMapView_Latitude_Property : ::g::Uno::UX::Property1
{
    uWeak< ::g::Fuse::Controls::MapView*> _obj;

    void ctor_3(::g::Fuse::Controls::MapView* obj, ::g::Uno::UX::Selector name);
    static PleaseWork_FuseControlsMapView_Latitude_Property* New1(::g::Fuse::Controls::MapView* obj, ::g::Uno::UX::Selector name);
};
// }
