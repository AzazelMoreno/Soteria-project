...
public class ViewFactory
{
    ...
    public static Object InstantiateViewGroupImpl238()
    {
        android.widget.FrameLayout frameLayout = new com.fuse.android.views.ViewGroup(com.apps.pleasework.PleaseWork.GetRootActivity());
