...
// C:\Users\rudy0\AppData\Local\Fusetools\Packages\Fuse.Testing\1.8.1\JavaScriptTest.uno
// -------------------------------------------------------------------------------------
...
// C:\Users\rudy0\AppData\Local\Fusetools\Packages\Fuse.Testing\1.8.1\TestRootPanel.uno
// ------------------------------------------------------------------------------------
        ...
        {
            {
                ...
                catch (const uThrowable& __t)
                {
                    ...
                    if (testFailedException != NULL)
                        ::g::Uno::Testing::Assert::Fail(uPtr(testFailedException)->Message(), uString::Const("C:\\Users\\rudy0\\AppData\\Local\\Fusetools\\Packages\\Fuse.Testing\\1.8.1\\TestRootPanel.uno"), 115, uString::Const("RunTest"));
                    else
                        throw __t;
                }
            }
        ...
        {
            {
                while (enum2.MoveNext(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Diagnostic_typeof(), NULL)))
                {
                    ...
                    ::g::Uno::Testing::Assert::Fail(uPtr(e1)->ToString(), uString::Const("C:\\Users\\rudy0\\AppData\\Local\\Fusetools\\Packages\\Fuse.Testing\\1.8.1\\TestRootPanel.uno"), 127, uString::Const("RunTest"));
                }
            }
        }
