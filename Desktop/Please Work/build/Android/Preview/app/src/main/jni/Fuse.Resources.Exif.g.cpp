...
// C:\Users\rudy0\AppData\Local\Fusetools\Packages\Fuse.Elements\1.8.1\Resources\Exif\Exif.uno
// -------------------------------------------------------------------------------------------
...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetOrientation118", "(Ljava/lang/Object;)I");
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "InputStreamFromByteArray119", "(Ljava/lang/Object;)Ljava/lang/Object;");
...
static void ExifData_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\rudy0\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.8.1\\Resources\\Exif\\Exif.uno");
