...
// C:\Users\rudy0\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.8.1\FuseJS\Http.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\rudy0\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.8.1\FuseJS\Builtins.uno
// ---------------------------------------------------------------------------------------------------
...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Fuse::Scripting::Function* setTimout = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::STRINGS[1/*"fuse-builti...*/], uPtr(::g::FuseScriptingJavaScript_bundle::setTimeoute6c17cdd())->ReadAllText()), ::TYPES[2/*Fuse.Scripting.Function*/]);
    ...
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], uPtr(::g::FuseScriptingJavaScript_bundle::es6promisemin289652d5())->ReadAllText());
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], ::STRINGS[4/*"ES6Promise....*/]);
    ::g::Fuse::Reactive::FuseJS::DiagnosticsImplModule::New2();
    ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Diagnostics7640b9e2()))->EvaluateExports(context, ::STRINGS[5/*"FuseJS/Diag...*/]);
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Observabledecfbc85()))->EvaluateExports(context, ::STRINGS[6/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
    TreeObservable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::TreeObservable2ed0f55f()))->EvaluateExports(context, ::STRINGS[7/*"FuseJS/Tree...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
// C:\Users\rudy0\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.8.1\FuseJS\Timer.uno
// ------------------------------------------------------------------------------------------------
...
// C:\Users\rudy0\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.8.1\FuseJS\DiagnosticsImpl.uno
// ----------------------------------------------------------------------------------------------------------
...
static void DiagnosticsImplModule_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("C:\\Users\\rudy0\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting.JavaScript\\1.8.1\\FuseJS\\DiagnosticsImpl.uno");
...
uObject* TimerModule::Delete(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::g::Fuse::MarshalException_typeof()))
        {
            ...
            ::g::Fuse::Diagnostics::UserWarning(uString::Const("Timer.delete(): The parameter is not a valid timer handle"), this, uString::Const("C:\\Users\\rudy0\\AppData\\Local\\Fusetools\\Packages\\Fuse.Scripting.JavaScript\\1.8.1\\FuseJS\\Timer.uno"), 133, uString::Const("Delete"));
        }
        else         throw __t;
    }
