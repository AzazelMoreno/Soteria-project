...
public class Slider
{
    ...
    public static void AddChangedCallback174(final UnoObject _this, final Object handle)
    {
        ((android.widget.SeekBar)handle).setOnSeekBarChangeListener(new android.widget.SeekBar.OnSeekBarChangeListener() {
        	public void onProgressChanged(android.widget.SeekBar seekBar, int progress, boolean fromUser) {
        		ExternedBlockHost.callUno_Fuse_Controls_Native_Android_Slider_OnSeekBarChanged175((UnoObject)_this,(double)progress / 1000.0,(boolean)fromUser);
        	}
    ...
    public static void SetProgress177(final Object handle,final double progress)
    {
