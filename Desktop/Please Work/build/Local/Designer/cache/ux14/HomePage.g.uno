...
public partial class HomePage: Fuse.Controls.Page
{
    ...
    void InitializeUX()
    {
        ...
        var temp15 = new global::Hamburger();
        var temp16 = new global::Fuse.Reactive.DataBinding(temp1_Latitude_inst, temp7, Fuse.Reactive.BindingMode.Default);
        var temp17 = new global::Fuse.Reactive.DataBinding(temp1_Longitude_inst, temp9, Fuse.Reactive.BindingMode.Default);
        temp10.LineNumber = 3;
